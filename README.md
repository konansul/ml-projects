...
- Kaggle Competitions: In addition to algorithm-specific notebooks, this repository includes folders dedicated to Kaggle competitions. These are organized separately by competition name. Each competition has its own folder containing: data files (if allowed), EDA and preprocessing, model training and evaluation, submission files and leaderboard tracking. For more complex competitions, separate repositories are created and linked from this main profile. 
